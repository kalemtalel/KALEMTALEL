...
// Pizza Thon/Pepperoni avec choix
...
// Pizza Thon Modal (La Casa De Mama)
...
// Anchilada Modal (La Casa De Mama)
...
// Pizza 4 Fromage Modal (La Casa De Mama)
...
const sandwichDidiOptionsList = [
    { name: "Sandwich thon frit", price: "7", description: "avec frite" },
    { name: "Sandwich kafteji frit", price: "4", description: "avec frite" },
    { name: "Sandwich poulet frit", price: "5", description: "avec frite" }
];
...
// Makloub Modal (La Casa De Mama)
const makloubLaCasaOptionsList = [
    { name: "Escalope grillée", price: "7.5" },
    { name: "Escalope panée", price: "8" },
    { name: "Shawarma", price: "7.5" },
    { name: "Cordon bleu", price: "9" },
    { name: "Thon", price: "6" },
    { name: "Jambon", price: "6" }
];
...
function showMakloubLaCasaModal(mode) {
    ...
    optionsContainer.innerHTML = makloubLaCasaOptionsList.map(opt => `
        <div class="makloub-lacasa-option-btn" onclick="selectMakloubLaCasaOption('${opt.name.replace(/'/g, "\\'")}', '${opt.price}')">
            <div style="flex: 1;">
...
// Pain Corné Modal (La Casa De Mama)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('click', function(event) {
        ...
        if (panel && float && !panel.contains(event.target) && !float.contains(event.target) && panel.classList.contains('show')) {
